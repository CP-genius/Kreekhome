...
function loadNativeAdIntoSlot(slotId) {
    ...
    // FIX: Removed the redundant script loading AD_CONFIG.native.scriptSrc.
    // The main script is loaded once globally in createNativeAdSlot, 
    // and only the atOptions need to be defined per slot.
    const adCode = `
